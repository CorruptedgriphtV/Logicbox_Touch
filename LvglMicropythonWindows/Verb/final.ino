...
#include <SPI.h> // <--- Agregar esta línea para definir VSPI
#include <esp32-hal-spi.h> // agregado para definir VSPI
#include <lvgl.h>
#include <TFT_eSPI.h>
...
// Remove the explicit TFT_eSPI instance, lv_tft_espi handles it.
...
// Cambiar la definición de DRAW_BUF_SIZE para usar cast a uint32_t y sufijo UL para evitar overflow:
#define DRAW_BUF_SIZE (((uint32_t)SCREEN_WIDTH * SCREEN_HEIGHT) / 10 * (LV_COLOR_DEPTH / 8UL))
